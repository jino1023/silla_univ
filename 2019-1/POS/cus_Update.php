        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" method="post" action="cus_cfUpdate.php">           

                  <div class="form-group ">
                    <label for="customerName" class="control-label col-lg-2">고객이름</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="customerName" name="customerName" type="text" value="<?=$customerName?>" />
                    </div>
                  </div>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="customerCall" name="customerCall" type="text" value="<?=$customerCall?>" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control" id="customerPoint" name="customerPoint" type="text" value="<?=$customerPoint?>" />
                    </div>
                  </div>
